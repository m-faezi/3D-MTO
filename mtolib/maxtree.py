...
class OriginalMaxTree(MaxTree):
    def __init__(self, image, verbosity, params):
        ...
        c_img = mt_class.Image(img_pointer, image.shape[1], image.shape[2], image.shape[0], image.size)
        ...
        # Set verbosity
        self.mt_lib.mt_set_verbosity_level.argtypes = (ct.POINTER(mt_class.MtData), ct.c_int)
